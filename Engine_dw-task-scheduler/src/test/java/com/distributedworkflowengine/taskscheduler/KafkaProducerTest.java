...
import com.distributedworkflowengine.taskscheduler.taskScheduler;
import com.distributedworkflowengine.taskscheduler.domain.Agent;
import com.distributedworkflowengine.taskscheduler.messaging.TaskSchedulerProducer;
...
//     Hamcrest Matchers to check the value
  assertThat(received, hasValue(agent2));
  
  }
  
  private void assertThat(ConsumerRecord<String, String> received, Matcher<ConsumerRecord<?,Agent>> hasValue) {
