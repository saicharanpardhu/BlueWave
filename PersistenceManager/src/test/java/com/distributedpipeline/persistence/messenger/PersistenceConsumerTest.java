...
@SpringBootTest
public class PersistenceConsumerTest {
	@Autowired
...
//		
//		Report report = new Report(new Long(16), new Timestamp(System.currentTimeMillis()),"akshay", "generic message","fatal");
