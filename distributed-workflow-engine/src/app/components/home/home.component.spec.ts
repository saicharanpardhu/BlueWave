...
import { CreateWorkflowComponent,DialogOverviewDialog, WnameOverviewDialog, SettingsDialog, JsonEditor  } from '../create-workflow/create-workflow.component';
...
describe('HomeComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers:   [ AppConfig, SocketService, WorkflowDetailsService, PerisitenceService, AuthGuardService, SocketService, StompService, ReportService, AuthenticationService,
